...
function App() {
    return (
        <div className="container">
            ...
            <a className="logo-expand" href="#u">Skateboard</a>
            <div className="side-wrapper">
            <div className="side-title">MENU</div>
            <div className="side-menu">
                <a className="sidebar-link discover is-active" href="#u">
                <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M9.135 20.773v-3.057c0-.78.637-1.414 1.423-1.414h2.875c.377 0 .74.15 1.006.414.267.265.417.625.417 1v3.057c-.002.325.126.637.356.867.23.23.544.36.87.36h1.962a3.46 3.46 0 002.443-1 3.41 3.41 0 001.013-2.422V9.867c0-.735-.328-1.431-.895-1.902l-6.671-5.29a3.097 3.097 0 00-3.949.072L3.467 7.965A2.474 2.474 0 002.5 9.867v8.702C2.5 20.464 4.047 22 5.956 22h1.916c.68 0 1.231-.544 1.236-1.218l.027-.009z" />
                </svg>
                Discover
                </a>
                <a className="sidebar-link trending" href="#u">
                <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <a className="sidebar-link" href="#u">
                <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="main-blogs">
                ...
                <img className="author-img" src="https://images.unsplash.com/photo-1560941001-d4b52ad00ecc?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80" alt="" />
                </div>
                ...
                <img className="author-img" src="https://images.unsplash.com/photo-1496345875659-11f7dd282d1d?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mzl8fG1lbnxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
                </div>
                <div className="author-detail">
            ...
            <div className="videos">
                ...
                <img className="author-img" src="https://images.pexels.com/photos/1680172/pexels-photo-1680172.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt="" />
                </div>
                </div>
                ...
                <img className="author-img" src="https://images.pexels.com/photos/3370021/pexels-photo-3370021.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt="" />
                </div>
                </div>
                ...
                <img className="author-img" src="https://images.pexels.com/photos/1870163/pexels-photo-1870163.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt="author-img" />
                </div>
                </div>
                ...
                <img className="author-img" src="https://images.pexels.com/photos/2889942/pexels-photo-2889942.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt="" />
                </div>
                </div>
            ...
            <div className="stream-area">
                ...
                <div className="message anim" style={{delay: '.4s'}}>
                    ...
                    <img className="author-img" src="https://images.pexels.com/photos/1870163/pexels-photo-1870163.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt="" />
                    </div>
                    <div className="msg-wrapper">
                ...
                <div className="chat-vid__wrapper">
                    <img className="chat-vid__img" src="https://cdn.nohat.cc/thumb/f/720/3b55eddcfffa4e87897d.jpg" alt='' />
                ...
                <div className="chat-vid__wrapper">
                    <img className="chat-vid__img" src="https://iamaround.it/wp-content/uploads/2015/02/pexels-photo-4663818.jpeg" alt="" />
                    <div className="chat-vid__content">
                    <div className="chat-vid__name">Prepare for your first skateboard jump</div>
                    <div className="chat-vid__by">Jordan Wise</div>
                    <div className="chat-vid__info">125.908 views <span className="seperate"></span>2 days ago</div>
